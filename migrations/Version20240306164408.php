 ...
 */
final class Version20240306164408 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commentaire (id INT AUTO_INCREMENT NOT NULL, publication_id INT NOT NULL, description VARCHAR(255) NOT NULL, datecomnt DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, active TINYINT(1) NOT NULL, likes INT DEFAULT 0 NOT NULL, INDEX IDX_67F068BC38B217A7 (publication_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
